...
pub fn render(screen: &mut Screen, ui: &mut egui::Ui) {
    ...
    if let Screen::Input { joinid } = screen {
        ...
        let clear_button =
            egui::widgets::Button::new(RichText::new("clear").size(30.0).color(Color32::WHITE))
                .min_size(Vec2 { x: 100.0, y: 50.0 });

        let back_button =
            egui::widgets::Button::new(RichText::new("back").size(30.0).color(Color32::WHITE))
                .min_size(Vec2 { x: 100.0, y: 50.0 });

        let join_button =
            egui::widgets::Button::new(RichText::new("join").size(30.0).color(Color32::WHITE))
                .min_size(Vec2 { x: 100.0, y: 50.0 });
        ...
        egui::Grid::new("keypad").show(ui, |ui| {
            ...
            for _i in num_array {
                let keypad_button = egui::widgets::Button::new(
                    RichText::new(_i.to_string())
                        .size(30.0)
                        .color(Color32::WHITE),
                )
                .min_size(Vec2 { x: 100.0, y: 50.0 });
            ...
            let zero_button =
                egui::widgets::Button::new(RichText::new('0').size(30.0).color(Color32::WHITE))
                    .min_size(Vec2 { x: 100.0, y: 50.0 });
